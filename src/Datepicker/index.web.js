...
const Datepicker = compose(
  ...
  const customCss = `
    ${baseCustomCss}
    .react-datepicker__input-container input {
      ${createDomStyle(theme.input.regular.background)}
      ${createDomStyle(theme.input.regular.border)}
      ${createDomStyle(theme.input.regular.text)}
      ${createDomStyle(theme.input.regular.opacity)}
    }
    .react-datepicker__day--selected,
    .react-datepicker__day--in-selecting-range,
    .react-datepicker__day--in-range,
    .react-datepicker__day--keyboard-selected {
      background-color: ${StyleSheet.flatten(theme.colors[theme.colors.secondary].background).backgroundColor};
    }
    ...
    .react-datepicker__input-container input {
      ...
      ${disabled ? `
        ...
        ${createDomStyle(theme.input.disabled.text)}
        ${createDomStyle(theme.input.disabled.opacity)}
      ` : ''}
    }
    ${!date ? `
      .react-datepicker__input-container input::placeholder {
        ${disabled ? createDomStyle(theme.input.disabled.placeholder) : createDomStyle(theme.input.regular.placeholder)}
      }
    ` : ''}
  `;
